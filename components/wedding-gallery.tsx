...
import { weddingCategories, weddingMoments, type WeddingMoment } from '@/lib/wedding-data';
...
export default function WeddingGallery() {
  ...
  const handleDownload = (moment: WeddingMoment) => {
    ...
    const downloadUrl = `https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}/image/upload/fl_attachment/${moment.cloudinaryId}`;
                  ...
                  <div className="relative cursor-pointer">
                    {moment.type === 'image' ? (
                      ...
                      <div className="relative">
                        <CldImage
                          src={`${moment.cloudinaryId}.jpg`} // Thumbnail del video
                          alt={moment.title}
                          width={400}
                          height={300}
